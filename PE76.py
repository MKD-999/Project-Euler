...
# As we are interested only in the case where we can write a number as a sum of at least 2nums
...
# However we consider the case when i = n
# This means j = i = n
# Which means we are also including the case where we are writing n as n itself
# So have to remove this 1 case
# So we return answer - 1
